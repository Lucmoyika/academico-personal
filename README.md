...
# Disclaimer
The Filament version is still work in progress. Please use with caution, and report bugs if you encounter them. Contributions are welcome to make Lumo-Solution a better, more usable software.
...
This application is intended to run locally (for example with Laragon) using PHP 8.3 and MariaDB/MySQL.
...
- Node.js + npm
- MariaDB/MySQL
- A local web stack such as Laragon
...
Any older Docker/FrankenPHP setup instructions should be considered legacy and ignored for local Laragon-based development.
